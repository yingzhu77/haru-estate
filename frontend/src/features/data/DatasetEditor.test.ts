...
function dataset(): Dataset {
  return {
    ...
    phases: [{ id: 'phase-1', name: '一期', area: '100', price: '200', sales_start: '2026-09', sales_months: 6, delivery_month: '2027-02', known_on: '2026-08-01' }],
    contracts: [{
      id: 'signed-1', phase_id: 'phase-1', area: '10', amount: '2000', sale_month: '2026-08',
      known_on: '2026-08-01', recognized_month: null, collections: [{ month: '2026-08', amount: '600' }],
    }],
    costs: [], actuals: [],
    assumptions: {
      opening_month: '2026-01', opening_cash: '0', monthly_overhead: '0', marketing_rate: '0',
      tax_rate: '0', down_payment_rate: '0.3', collection_lag: 3, expense_payment_lag: 0,
      loan_limit: '0', annual_interest_rate: '0',
    },
  }
}
function open(data: Dataset) {
  return shallowMount(DatasetEditor, { props: { modelValue: data, knownOn: '2026-08-31' }, global: {
    renderStubDefaultSlot: true,
    stubs: {
      ElTabs: true, ElTabPane: true, ElEmpty: true,
